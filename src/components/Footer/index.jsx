...
const FooterContainer = styled.footer`
  ...
  height: 209px;
  margin-top: 27px;
  padding: 66px 120.313px 58px 121.094px;
...
const FooterParagraphe = styled.p`
  display: flex;
  width: 100%;
  height: 46px;
  flex-direction: column;
